  ...
  <section id="portfolio" class="portfolio-section">
    <div class="container">
      ...
      <div class="projects-grid" data-aos="fade-up" data-aos-delay="300">
        ...
        >
        <img :src="getProjectImagePath(project.image)" :alt="project.title" />
    ...
    <div v-if="modalProject" class="project-modal" @click="closeModal">
      <div class="modal-content" @click.stop>
        ...
        <img
           :src="getProjectImagePath(modalProject.image)"
...
export default {
  ...
  methods: {
    ...
    getProjectImagePath(imageName) {
      // Construct the image path dynamically
      return new URL(`../assets/protfolio/${imageName}`, import.meta.url).href;
    },
  }
};
</script>
